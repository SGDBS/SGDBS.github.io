...
+
$$
$min\_{p\_\*q\_\*b\_\*}$ $\sum\_{(u,i)\in$ $K}\qquad$ $(r\_{ui}-\mu-b\_u-b\_i-p\_u^Tq\_i)+\lambda(||p\_u||^2+||q\_i||^2+b\_u^2+q\_i^2)$
$$
...
* b
  ...
  i
  −
$b\_u' = b\_u+\gamma \*(e\_{ui}-\lambda b\_u)$
* b
  i
  ′
  =
  ...
  i
  −
$b\_i' = b\_i+\gamma \*(e\_{ui}-\lambda b\_i)$
* p
  u
  ′
  =
  ...
  i
  −
$p\_u' = p\_u + \gamma \*(e\_{ui} \* p\_i -\lambda p\_u)$
* p
  i
  ′
  =
  ...
  u
  −
$p\_i' = p\_i + \gamma \*(e\_{ui} \* p\_u -\lambda p\_i)$
