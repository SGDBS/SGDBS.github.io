...
l
Kruskal
Kruskal重构树**,不了解的可以去了解一下,或者看看[我写的简要版本](https://blog.csdn.net/SGDBS233/article/details/121718833),我写的比较简略,完全没有学过的可以去看看别的博客,[比如这个](https://www.cnblogs.com/wizarderror/p/12187451.html)。
...
l
Kruskal
Kruskal重构树解决,所以我们不妨来试一试 ~~(其实蒟蒻根本想不到别的方法了QAQ)~~
